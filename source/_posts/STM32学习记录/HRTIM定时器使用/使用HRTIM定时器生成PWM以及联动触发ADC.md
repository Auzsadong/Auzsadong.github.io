...
static void Boost_SetDutyPermille(uint16_t duty_pm)
{
  ...
  /*
   * Edge-aligned Boost PWM:
   * PWM high: 0 -> CMP1, PWM low: CMP1 -> PERIOD.
   * ADC trigger CMP4 is placed at the PWM low-level midpoint.
   */
  cmp1 = (BOOST_HRTIM_PERIOD * duty_pm) / 1000U;
